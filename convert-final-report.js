...
const files = [
  {
    input: path.join(__dirname, '04_Reports_&_Paper', 'Final_Technical_Report', 'Dokumen_Kompilasi.md'),
    output: path.join(__dirname, '04_Reports_&_Paper', 'Final_Technical_Report', 'Dokumen_Kompilasi.pdf'),
    title: 'Dokumen Kompilasi Teknis — Sistem Lost & Found IPB',
  },
  {
    input: path.join(__dirname, '04_Reports_&_Paper', 'Final_Technical_Report', 'User_Manual.md'),
    output: path.join(__dirname, '04_Reports_&_Paper', 'Final_Technical_Report', 'User_Manual.pdf'),
    title: 'User Manual — Sistem Lost & Found IPB',
  },
];
...
const css = `
  ...
  * { box-sizing: border-box; }
  ...
  hr { border: none; border-top: 2px solid #e94560; margin: 24px 0; opacity: 0.3; }
...
async function convert() {
  console.log('Memulai konversi Final Technical Report...\n');
        ...
        { path: file.input },
        {
          ...
          pdf_options: {
            ...
            headerTemplate:
              ...
              'Keamanan Informasi (KOM1315) &mdash; Kelompok 2 &mdash; IPB University' +
              '</div>',
            footerTemplate:
  ...
  console.log('\nKonversi selesai!');
  console.log('File PDF tersimpan:');
